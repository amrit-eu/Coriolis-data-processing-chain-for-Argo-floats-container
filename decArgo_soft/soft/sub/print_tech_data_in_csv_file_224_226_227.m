...
%
% SYNTAX :
%  print_tech_data_in_csv_file_224_226_227(a_tabTech1, a_tabTech2, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_tech_data_in_csv_file_224_226_227(a_tabTech1, a_tabTech2, a_deepCycle)
...
elseif (length(idF2) == 1)
   ...
   if (a_deepCycle == 1)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; "Subsurface" meas PRES; %d; => %.1f; dbar\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 15+ID_OFFSET), sensor_2_value_for_pressure_202_210_to_214_217_222_to_227(a_tabTech2(id, 15+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; "Subsurface" meas TEMP; %d; => %.3f; degC\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 16+ID_OFFSET), sensor_2_value_for_temp_204_to_214_217_219_220_222_to_227(a_tabTech2(id, 16+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; "Subsurface" meas PSAL; %d; => %.3f; PSU\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 17+ID_OFFSET), sensor_2_value_for_salinity_210_to_214_217_220_222_to_227(a_tabTech2(id, 17+ID_OFFSET)));
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; Ice detection flag (1: ISA, 2: Sat mask, 3: ISA & Sat mask, 4: Ascent hanging); %d\n', ...
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; min "in air" PSAL meas; %d; => %.3f; PSU\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 63+ID_OFFSET), sensor_2_value_for_salinity_210_to_214_217_220_222_to_227(a_tabTech2(id, 63+ID_OFFSET)));
end
