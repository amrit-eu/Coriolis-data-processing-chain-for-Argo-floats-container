...
elseif (length(idF2) == 1)
   ...
   if (a_deepCycle == 1)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas PRES; %d; => %.1f; dbar\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 10+ID_OFFSET), sensor_2_value_for_pressure_201_203_215_216_218_221_228_229(a_tabTech2(id, 10+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas TEMP; %d; => %.3f; degC\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 11+ID_OFFSET), sensor_2_value_for_temperature_2xx_1_to_3_15_16_18_21_28_29(a_tabTech2(id, 11+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas PSAL; %d; => %.3f; PSU\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 12+ID_OFFSET), sensor_2_value_for_salinity_201_to_203_215_216_218_221_228_229(a_tabTech2(id, 12+ID_OFFSET)));
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Ice detection flag (1: ISA, 2: Sat mask, 3: ISA & Sat mask, 4: Ascent hanging); %d\n', ...
